...
uint256 hashGenesisBlock("0x4b6561a5f6ea9f692d72a28415b7e778c10dbbe4014a0cf91bdca4e47bf508b9");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    int64 nSubsidy = 7880000000 * COIN;

    if (nHeight > 1) nSubsidy = 0;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Thousands of Jobs to Be Lost at Shipbuilders";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1439685474; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2271525;

        if (fTestNet)
        {
            block.nTime    = 1439679750;
            block.nNonce   = 440824;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0eddbec8e0169d0fb3b78abdc2a02f1e6571cd90789268ae6713cdc126ad76ac"));
